...
bool validate_hash(std::ostream & stream){
    ...
    stream << "   HMACSHA512: \t\t" << (correct?"Passed":"Failed") << std::endl;
    all_correct &= correct;
